...
/**
 * @author: YI
 * @description: 使用MapState来维持中间数据，方便增量计算，这里用来做一个金币防作弊的功能
 * @date: create in 2021/6/2 15:47
 */
public class FlinkStateMapState {
    ...
    public static class CheatingAlarmWindow extends RichWindowFunction<CurrencyChanges, String, String, GlobalWindow> {
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            // 初始化State
            cheatState = getRuntimeContext().getMapState(new MapStateDescriptor<>("cheatState",
